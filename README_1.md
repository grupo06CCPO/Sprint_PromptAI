...
- **Resposta ideal:** "Há 2 carregadores disponíveis no momento. Localize o mais próximo pelo mapa do aplicativo."

**4. Alertas de sobrecarga (administrador)**
- **Pergunta:** "Existe algum alerta ativo no sistema?"
- **Resposta ideal:** "Alertas ativos: SOBRECARGA NO ELETROPOSTO 05."

**5. Relatório dos eletropostos (administrador)**
- **Pergunta:** "Me dá um relatório dos eletropostos."
- **Resposta ideal:**
  ```
  📊 Relatório rápido dos eletropostos:
...
- **Resposta ideal:** "Falhas registradas: FALHA NO PAGAMENTO — CLIENTE_X | ELETROPOSTO_04."
